...
public class SecurityConfig {
    ...
    protected SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        http
                ...
                .requestMatchers(HttpMethod.PUT, "/inspection/add/repair/{id}/{repairId}").hasAnyRole("BACK_OFFICE_EMPLOYEE", "ADMIN")
                .requestMatchers(HttpMethod.PUT, "/inspection/add/car/{inspectionId}").hasAnyRole("BACK_OFFICE_EMPLOYEE", "ADMIN")
