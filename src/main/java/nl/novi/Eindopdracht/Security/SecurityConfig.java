...
public class SecurityConfig {
    ...
    protected SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        http
                ...
                .requestMatchers(HttpMethod.GET, "/parts/sparkPlugs/find/{id}").hasAnyRole("MECHANIC","BACK_OFFICE_EMPLOYEE", "ADMIN")
                ...
                .requestMatchers(HttpMethod.GET, "/parts/tyres/find/{id}").hasAnyRole("MECHANIC","BACK_OFFICE_EMPLOYEE" ,"ADMIN")
                ...
                .requestMatchers(HttpMethod.GET, "/parts/brakes/find/{id}").hasAnyRole("MECHANIC","BACK_OFFICE_EMPLOYEE", "ADMIN")
                ...
                .requestMatchers(HttpMethod.GET, "/inspection/find/{id}").hasAnyRole("MECHANIC","SERVICE_SPECIALIST", "ADMIN")
                .requestMatchers(HttpMethod.GET, "/inspection/find/all/").hasAnyRole("MECHANIC","SERVICE_SPECIALIST", "ADMIN")
                .requestMatchers(HttpMethod.PUT, "/inspection/update/mileage/{id}").hasAnyRole("MECHANIC", "ADMIN")
                .requestMatchers(HttpMethod.PUT, "/inspection/update/inspectionDate/{id}").hasAnyRole("MECHANIC", "ADMIN")
                .requestMatchers(HttpMethod.PUT, "/inspection/add/repair/{id}/{repairId}").hasAnyRole("MECHANIC", "ADMIN")
                .requestMatchers(HttpMethod.PUT, "/inspection/add/car/{inspectionId}").hasAnyRole("MECHANIC", "ADMIN")
                .requestMatchers(HttpMethod.PUT, "/inspection/update/carIsCorrect/{id}").hasAnyRole("MECHANIC", "ADMIN")
                .requestMatchers(HttpMethod.DELETE, "/inspection/delete/inspection/{id}").hasAnyRole("SERVICE_SPECIALIST", "ADMIN")
                ...
                .requestMatchers(HttpMethod.PUT, "/carRepair/update/car-problem/{id}").hasAnyRole("MECHANIC", "ADMIN")
                .requestMatchers(HttpMethod.PUT, "/carRepair/update/repair-date/{id}").hasAnyRole("MECHANIC", "ADMIN")
                .requestMatchers(HttpMethod.PUT, "/carRepair/{carRepairId}/add/parts").hasAnyRole("MECHANIC", "ADMIN")
                .requestMatchers(HttpMethod.DELETE, "/carRepair/delete/{id}").hasAnyRole("SERVICE_SPECIALIST", "ADMIN")
                ...
                .requestMatchers(HttpMethod.PUT, "/customer/update/name/{id}").hasAnyRole("MECHANIC", "ADMIN")
